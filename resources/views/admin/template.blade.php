...
<html
  ...
  data-assets-path="{{asset('admin_asset/')}}"
...
>
  <head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="{{asset('admin_asset/img/favicon/favicon.ico')}}" />
    ...
    <link rel="stylesheet" href="{{asset('admin_asset/vendor/fonts/boxicons.css')}}" />

    <!-- Core CSS -->
    <link rel="stylesheet" href="{{asset('admin_asset/vendor/css/core.css')}}" class="template-customizer-core-css" />
    <link rel="stylesheet" href="{{asset('admin_asset/vendor/css/theme-default.css')}}" class="template-customizer-theme-css" />
    ...
    <!-- Helpers -->
    <script src="{{asset('admin_asset/vendor/js/helpers.js')}}"></script>
                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                  <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                    <div class="avatar avatar-online">
                      <img src="{{asset('admin_asset/img/avatars/1.png')}}" alt class="w-px-40 h-auto rounded-circle" />
                    </div>
                  </a>
